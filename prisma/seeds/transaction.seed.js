...
const TRANSACTION_DATA = [
  ...
  { id: 4, marketPostingId: 4, buyerId: 5, quantity: 1 },
  { id: 5, marketPostingId: 7, buyerId: 6, quantity: 2 },
  { id: 6, marketPostingId: 9, buyerId: 7, quantity: 1 },
  { id: 7, marketPostingId: 10, buyerId: 8, quantity: 1 },
  { id: 8, marketPostingId: 11, buyerId: 9, quantity: 1 },
  { id: 9, marketPostingId: 12, buyerId: 10, quantity: 1 },
...
async function seedTransactions(tx, seedData) {
  ...
  const transactions = TRANSACTION_DATA.map((transaction, index) => {
    ...
    return {
      ...
      createdAt: new Date(
        seededAt.getTime() - (index + 1) * 3 * 60 * 60 * 1000,
      ),
    };
  });
